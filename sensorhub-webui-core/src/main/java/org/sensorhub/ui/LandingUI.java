...
public class LandingUI extends UI{
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        for(var module : modules){
            ...
            if(!(module instanceof AbstractHttpServiceModule) && !(module instanceof IServiceModule) || panelMap.containsKey(module.getClass().getCanonicalName())) continue;

//            if(panelMap.containsKey(module.getClass().getCanonicalName())){
//                log.warn("Duplicated panel: {}", module.getClass());
//                continue;
//            }


            //   case 1: module has no permissions
                // here I want to show the modules with no permissions or security to all users regardless
            //  case 2: module has permissions, but the user cannot access them
            // case 3: module has permissions. and the user does have access
...
//        layout.setExpandRatio(button, 0.0f);
