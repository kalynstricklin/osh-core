...
public abstract class DataTree<T extends DataComponent, B extends BaseBuilder<T>>
{
    ...
    */
    ...
    public static DataTree<DataComponent,?> create(Class<?> clazz)
    {
        if (DataRecord.class.equals(clazz))
            return (DataTree)new DataRecordResourceTree();
        else
            throw new IllegalStateException("Unsupported resource type: " + clazz);
    }
    ...
    protected Object toTreeItem(TreeTable tree, Object parentId, String name, Supplier<? extends DataComponent> newResource, DataComponent nestedResource)
    {
    ...
    Object renderSubResourceTree(TreeTable tree, Object parentId, DataComponent resource)
    {
        tree.setChildrenAllowed(parentId, true);
        var ft = DataTree.create(resource.getClass());
